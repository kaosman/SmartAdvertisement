...
public class ViewFairViewAds extends Activity implements OnItemClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_view_fair_view_ads);

		listView = (ListView) findViewById(R.id.listview_fair);
		...
		case 0 : if(Utils.isNetworkAvailable(ViewFairViewAds.this)) {
		...
		case 1 : if(Utils.isNetworkAvailable(ViewFairViewAds.this)) {
		...
		case 2 : if(Utils.isNetworkAvailable(ViewFairViewAds.this)) {
		...
		case 3 : if(Utils.isNetworkAvailable(ViewFairViewAds.this)) {
		...
		case 4 : if(Utils.isNetworkAvailable(ViewFairViewAds.this)) {
	...
	class MyTask extends AsyncTask<String, Void, Void> {
		...
		protected void onPreExecute() {
			...
			pDialog = new ProgressDialog(ViewFairViewAds.this);
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
		...
		Intent intent = new Intent(ViewFairViewAds.this, DetailActivity.class);
	...
	public void setAdapterToListview() {
		NewsRowAdapter objAdapter = new NewsRowAdapter(ViewFairViewAds.this,
