...
public class ViewUptownAds extends Activity implements OnItemClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_view_uptown_ads);

		listView = (ListView) findViewById(R.id.listview_upt);
		...
		case 0 : if(Utils.isNetworkAvailable(ViewUptownAds.this)) {
		...
		case 1 : if(Utils.isNetworkAvailable(ViewUptownAds.this)) {
		...
		case 2 : if(Utils.isNetworkAvailable(ViewUptownAds.this)) {
		...
		case 3 : if(Utils.isNetworkAvailable(ViewUptownAds.this)) {
		...
		case 4 : if(Utils.isNetworkAvailable(ViewUptownAds.this)) {
	...
	class MyTask extends AsyncTask<String, Void, Void> {
		...
		protected void onPreExecute() {
			...
			pDialog = new ProgressDialog(ViewUptownAds.this);
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
		...
		Intent intent = new Intent(ViewUptownAds.this, DetailActivity.class);
	...
	public void setAdapterToListview() {
		NewsRowAdapter objAdapter = new NewsRowAdapter(ViewUptownAds.this,
